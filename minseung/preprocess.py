...
def get_ski_data(sequential_size=0, sampling_frequency=1):
    ...
    # true_index_applied_sampling = np.arange(0, selected_sequential_indice.shape[0], sampling_frequency)

    # filtered_df = raw_df.iloc[selected_sequential_indice[true_index_applied_sampling]]
...
if __name__ == '__main__':
    get_ski_data(10, sampling_frequency=3)
